...
import app.parkme.com.clientapp.LoginActivity;
 ...
 */
public class ParkmeAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = this.getClass().getSimpleName();
    private final Context mContext;

    public ParkmeAuthenticator(Context context) {
        super(context);
    ...
    @Override
    public Bundle updateCredentials(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws
